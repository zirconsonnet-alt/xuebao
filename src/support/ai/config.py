...
_RUNTIME_DEFAULTS: Dict[str, Any] = {
    ...
    "official_llm_fallback_model": "deepseek-chat",
    "mcp_servers": [],
    "max_msg_count": 40,
...
_SECRETS_DEFAULTS: Dict[str, Any] = {
    ...
    "anthropic_api_key": "",
    "anthropic_base_url": "",
    "deepseek_api_key": "sk-9cec2901a76b4cc1823c35991fdcccc6",
...
def _normalize_runtime_config(data: Dict[str, Any]) -> Dict[str, Any]:
    ...
    normalized["official_llm_fallback_model"] = _coerce_str(
        data.get("official_llm_fallback_model"),
        normalized["official_llm_fallback_model"],
    ).strip()
