    ...
    async def activity_service_menu(self):
        ...
        flow = {
            ...
            "badges": [
                ...
                {"text": "活动流程入口", "tone": "success"},
            ],
            "sections": [
                {
                    "title": "活动操作",
                    "description": "从活动创建到审批、报名和个人查询，都可以直接进入。",
                    "columns": 2,
                    "items": [
                        {"index": "1", "title": "创建活动申请", "description": "提交新的活动申请。", "meta": "回复 1 执行", "status": "申请", "status_tone": "accent"},
                        {"index": "2", "title": "审批活动", "description": "处理待审批的活动。", "meta": "回复 2 执行", "status": "审批", "status_tone": "warning"},
                        {"index": "3", "title": "我要参加", "description": "查看并加入可参与的活动。", "meta": "回复 3 执行", "status": "参与", "status_tone": "success"},
                        {"index": "4", "title": "发起活动", "description": "直接发起新的群活动。", "meta": "回复 4 执行", "status": "发起", "status_tone": "accent"},
                        {"index": "5", "title": "通过活动", "description": "通过活动并推进后续流程。", "meta": "回复 5 执行", "status": "审核", "status_tone": "warning"},
                        {"index": "6", "title": "报名活动", "description": "进入活动报名流程。", "meta": "回复 6 执行", "status": "报名", "status_tone": "success"},
                        {"index": "7", "title": "刷新活动", "description": "同步当前活动列表状态。", "meta": "回复 7 执行", "status": "刷新", "status_tone": "accent"},
                        {"index": "8", "title": "我的活动", "description": "查看自己参与或创建的活动。", "meta": "回复 8 执行", "status": "查看", "status_tone": "success"},
                    ],
                }
            ],
            "hint": "输入【序号】或【指令】",
