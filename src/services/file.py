        ...
        try:
            file_system_flow = {
                ...
                "sections": [
                    {
                        "title": "文件服务操作",
                        "description": "支持文件整理、去重、背景修改以及更多设置入口。",
                        "columns": 2,
                        "items": [
                            {"index": "1", "title": "整理文件", "description": "按当前规则整理群文件。", "meta": "回复 1 执行", "status": "整理", "status_tone": "accent"},
                            {"index": "2", "title": "删除重名文件", "description": "清理重复文件条目。", "meta": "回复 2 执行", "status": "去重", "status_tone": "warning"},
                            {"index": "3", "title": "修改文件服务背景", "description": "更新当前服务菜单背景。", "meta": "回复 3 执行", "status": "个性化", "status_tone": "success"},
                            {"index": "4", "title": "设置", "description": "进入整理规则与自动整理设置。", "meta": "回复 4 进入", "status": "设置", "status_tone": "accent"},
                        ],
                    }
                ],
                "hint": "输入【序号】或【指令】",
                "routes": {
                    ...
                    "4": {
                        ...
                        "sections": [
                            {
                                "title": "设置入口",
                                "description": "选择要调整的文件服务子模块。",
                                "columns": 1,
                                "items": [
                                    {"index": "1", "title": "整理文件设置", "description": "查看或调整整理规则。", "meta": "回复 1 执行", "status": "规则", "status_tone": "accent"},
                                    {"index": "2", "title": "自动文件整理设置", "description": "调整自动整理相关计划。", "meta": "回复 2 执行", "status": "自动化", "status_tone": "success"},
                                    {"index": "3", "title": "个性化设置", "description": "处理背景等展示相关配置。", "meta": "回复 3 执行", "status": "个性化", "status_tone": "warning"},
                                ],
                            }
                        ],
                        "hint": "输入【序号】或【指令】",
