...
class ReminderService(BaseService):
    ...
    @service_action(cmd="任务收集", aliases={"收集任务"}, need_arg=True, desc="收集指定学习周期的任务", tool_callable=True)
    @check_enabled
    ...
    @service_action(cmd="任务查看", aliases={"查看任务"}, need_arg=True, desc="查看指定学习周期的任务", tool_callable=True)
    @check_enabled
    ...
    @service_action(cmd="目标", need_arg=True, desc="保存学习目标", tool_callable=True)
    @check_enabled
