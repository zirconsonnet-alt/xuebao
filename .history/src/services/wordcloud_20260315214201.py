...
class WordcloudService(BaseService):
    ...
    @service_action(cmd="本周词云", aliases={"本群本周词云", "我的本周词云"}, desc="生成本周词云", tool_callable=True)
    @check_enabled
    ...
    @service_action(cmd="上周词云", aliases={"本群上周词云", "我的上周词云"}, desc="生成上周词云", tool_callable=True)
    @check_enabled
    ...
    @service_action(cmd="本月词云", aliases={"本群本月词云", "我的本月词云"}, desc="生成本月词云", tool_callable=True)
    @check_enabled
    ...
    @service_action(cmd="上月词云", aliases={"本群上月词云", "我的上月词云"}, desc="生成上月词云", tool_callable=True)
    @check_enabled
    ...
    @service_action(cmd="年度词云", aliases={"本群年度词云", "我的年度词云"}, desc="生成年度词云", tool_callable=True)
    @check_enabled
    ...
    @service_action(cmd="历史词云", aliases={"本群历史词云", "我的历史词云"}, need_arg=True, desc="生成指定时间段词云（支持 ISO8601 或 开始~结束）", tool_callable=True)
    @check_enabled
