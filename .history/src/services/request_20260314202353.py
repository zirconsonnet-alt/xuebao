    ...
    async def request_system(self):
        try:
            request_system_flow = {
                ...
                "text": "请选择以下操作：\n1. 开启 / 关闭 入群审核\n2. 欢迎管理\n3. 入群问答管理\n4. 设置\n\n输入【序号】",
                "routes": {
                    "1": {"title": "入群审核开关", "text": "请选择操作：\n1. 开启入群审核服务\n2. 关闭入群审核服务\n\n输入【序号】", "routes": {"1": self.enable_service, "2": self.disable_service}},
                    "2": {"title": "欢迎管理", "text": "请选择操作：\n1. 设置欢迎内容\n2. 开启欢迎功能\n3. 关闭欢迎功能\n\n输入【序号】", "routes": {"1": self.set_welcome_nodes, "2": self.enable_welcome, "3": self.disable_welcome}},
                    "3": {"title": "入群问答管理", "text": "请选择操作：\n1. 设置入群答案\n2. 开启问答审核\n3. 关闭问答审核\n\n输入【序号】", "routes": {"1": self._set_answer_internal, "2": self.enable_answer, "3": self.disable_answer}},
                    "4": {"title": "入群管理 · 设置", "text": "⚙️ 暂无可配置项", "routes": {}},
                },
            }
